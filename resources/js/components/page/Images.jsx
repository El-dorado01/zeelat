...
import Image14 from '#@/images/rear-view-young-college-student.jpg';
...
const images = [
    ...
    { id: 'featured-3', src: Image14, alt: 'Young College Student' },
...
export const AppLogoIcon = () => {
    ...
    return <img src={AppLogo} style={{ width: "100%", height: "100%" }} alt="App Logo" />;
};
